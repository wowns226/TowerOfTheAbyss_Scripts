...
namespace ProjectL
{
    public class CooldownReduceWhenAttackTripod : Tripod
    {
        ...
        {
            D.SelfPlayer.onSharedAttackMob.Add(CooldownReduce);
        }

        public override void DeActivate()
        {
            D.SelfPlayer.onSharedAttackMob.Remove(CooldownReduce);
        }
