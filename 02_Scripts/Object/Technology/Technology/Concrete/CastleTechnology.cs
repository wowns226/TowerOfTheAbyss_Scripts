...
namespace ProjectL
{
    public class CastleTechnology : Technology
    {
        ...
        {
            firstTripods.Add(new CastleHealUpTripod());
            secondTripods.Add(new CastleReduceHealingTimeTripod());
        }
        ...
        {
            D.SelfPlayer.Castle.Upgrade(StatType.NaturalHealingValue, value);
        }
    }
}
