...
namespace ProjectL
{
    public enum EvilWatcherAnimType
    {
        IdleLookAround = 1,
        FlyForward = 5,
        FlyLeft = 7,
    ...
    public class EvilWatcher : EnemyMob
    {
        ...
        protected override void SpawnAnim()
        {
            ...
            unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.IdleLookAround);
        }
        ...
        protected override void DeathAnim()
        {
            ...
            if (CurrentAnim == (int)EvilWatcherAnimType.Death)
            {
                return;
            }

            unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.Death);
        }
        ...
        protected override void IdleAnim()
        {
            ...
            if (CurrentAnim == (int)EvilWatcherAnimType.GetHit)
            {
            ...
            if (CurrentAnim == (int)EvilWatcherAnimType.IdleLookAround)
            {
                return;
            }
        ...
        protected override void AttackAnim()
        {
            ...
            if (CurrentAnim == (int)EvilWatcherAnimType.Attack1
                || CurrentAnim == (int)EvilWatcherAnimType.Attack2
                || CurrentAnim == (int)EvilWatcherAnimType.GetHit)
            {
                if(unitAnimator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1.0f)
                {
                    return;
            ...
            {
                case 0:
                    StartAnimationWithReturnIdle(EvilWatcherAnimType.Attack1);
                    break;
                default:
                    StartAnimationWithReturnIdle(EvilWatcherAnimType.Attack2);
                    break;
            }
        ...
        protected override void StunAnim()
        {
            ...
            StartAnimationWithReturnIdle(EvilWatcherAnimType.GetHit);
        }
        ...
        protected override void RunAnim(bool isLeft, bool isBack, bool isSide)
        {
            ...
            if (isSide && isLeft)
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.FlyLeft);
            }
            else if (isSide && !isLeft)
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.FlyRight);
            }
            else if (isBack)
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.FlyForward);
            }
            else
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)EvilWatcherAnimType.LungeForward);
            }
        }
        ...
        private void StartAnimationWithReturnIdle(EvilWatcherAnimType animType)
        {
