...
namespace ProjectL
{
    public enum CyclopsAnimType
    {
        idleLookAround = 1,
        walk = 5,
        Death = 13,
        getHit1 = 17,
        fists2CrushAttack = 21,
        fists2SmashAttack90Left = 22,
        fists2SmashAttack90Right = 23,
        fists2SmashAttackForward = 24,
        Hit2ComboAttack = 25,
        Hit3ComboAttack = 26,
        leftHandAttack = 27,
        rightHandAttack = 28,
    ...
    public class CyclopsAttacker : EnemyMob
    {
