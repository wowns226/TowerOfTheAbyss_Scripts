...
namespace ProjectL
{
    ...
    public class GiantRat : EnemyMob
    {
        ...
        protected override void SpawnAnim()
        {
            ...
            unitAnimator?.SetInteger(MOTION_KEY, (int)GiantRatAnimType.Taunt);
        }
        ...
        protected override void DeathAnim()
        {
            ...
            if (CurrentAnim == (int)GiantRatAnimType.Death)
            {
                return;
            }

            unitAnimator?.SetInteger(MOTION_KEY, (int)GiantRatAnimType.Death);
        }
        ...
        protected override void IdleAnim()
        {
            ...
            if (CurrentAnim == (int)GiantRatAnimType.GetHitFront)
            {
            ...
            if (CurrentAnim == (int)GiantRatAnimType.Taunt)
            {
                return;
            }
        ...
        protected override void AttackAnim()
        {
            ...
            if (CurrentAnim == (int)GiantRatAnimType.JumpBite
                || CurrentAnim == (int)GiantRatAnimType.GetHitFront)
            {
                if(unitAnimator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1.0f)
                {
                    return;
            ...
            StartAnimationWithReturnIdle(GiantRatAnimType.JumpBite);
        }
        ...
        protected override void StunAnim()
        {
            ...
            StartAnimationWithReturnIdle(GiantRatAnimType.GetHitFront);
        }
        ...
        protected override void RunAnim(bool isLeft, bool isBack, bool isSide)
        {
            ...
            if (isSide && isLeft)
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)GiantRatAnimType.walk);
            }
            ...
            {
                unitAnimator?.SetInteger(MOTION_KEY, (int)GiantRatAnimType.Run);
            }
        }
        ...
        private void StartAnimationWithReturnIdle(GiantRatAnimType animType)
        {
