...
namespace ProjectL
{
    public class MeleeUnitDefensebuffRelic : Relic
    {
        ...
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, commonValue);
        }
        
        protected override void _ActivateRare()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, epicValue);
        }
        
        protected override void _ActivateSpecial()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, specialValue);
        }
        
        protected override void _ActivateLegendary()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, legendaryValue);
        }
        
        protected override void _ActivateAncient()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, ancientValue);
        }
        
        protected override void _InActivateCommon()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, commonValue * -1);
        }
        
        protected override void _InActivateRare()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, rareValue * -1);
        }
        
        protected override void _InActivateUnique()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, uniqueValue * -1);
        }
        
        protected override void _InActivateEpic()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, epicValue * -1);
        }
        
        protected override void _InActivateSpecial()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, specialValue * -1);
        }
        
        protected override void _InActivateLegendary()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, legendaryValue * -1);
        }
        
        protected override void _InActivateAncient()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Defense, AttackType.Melee, ancientValue * -1);
        }
