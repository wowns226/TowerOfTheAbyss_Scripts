...
namespace ProjectL
{
    public class HealUnitHealbuffRelic : Relic
    {
        ...
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, commonValue);
        }
        
        protected override void _ActivateRare()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, epicValue);
        }

        protected override void _ActivateSpecial()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, specialValue);
        }

        protected override void _ActivateLegendary()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, legendaryValue);
        }

        protected override void _ActivateAncient()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, ancientValue);
        }

        protected override void _InActivateCommon()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, commonValue * -1);
        }

        protected override void _InActivateRare()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, rareValue * -1);
        }

        protected override void _InActivateUnique()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, uniqueValue * -1);
        }

        protected override void _InActivateEpic()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, epicValue * -1);
        }

        protected override void _InActivateSpecial()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, specialValue * -1);
        }

        protected override void _InActivateLegendary()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, legendaryValue * -1);
        }

        protected override void _InActivateAncient()
        {
            Player.UpgradeStatPercentage(UnitType.Mob, StatType.Heal, AttackType.Heal, ancientValue * -1);
        }
