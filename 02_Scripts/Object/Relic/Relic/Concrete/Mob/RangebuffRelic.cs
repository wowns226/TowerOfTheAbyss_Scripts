...
namespace ProjectL
{
    public class RangebuffRelic : Relic
    {
        ...
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, commonValue);
        }

        protected override void _ActivateRare()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, epicValue);
        }

        protected override void _ActivateSpecial()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, specialValue);
        }

        protected override void _ActivateLegendary()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, legendaryValue);
        }

        protected override void _ActivateAncient()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, ancientValue);
        }

        protected override void _InActivateCommon()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, commonValue * -1);
        }

        protected override void _InActivateRare()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, rareValue * -1);
        }

        protected override void _InActivateUnique()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, uniqueValue * -1);
        }

        protected override void _InActivateEpic()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, epicValue * -1);
        }

        protected override void _InActivateSpecial()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, specialValue * -1);
        }

        protected override void _InActivateLegendary()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, legendaryValue * -1);
        }

        protected override void _InActivateAncient() 
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.Range, ancientValue * -1);
        }
    }
}