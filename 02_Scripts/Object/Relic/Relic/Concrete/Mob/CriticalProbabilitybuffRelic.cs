...
namespace ProjectL
{
    public class CriticalProbabilitybuffRelic : Relic
    {
        ...
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, commonValue);
        }

        protected override void _ActivateRare()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, epicValue);
        }

        protected override void _ActivateSpecial()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, specialValue);
        }

        protected override void _ActivateLegendary()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, legendaryValue);
        }

        protected override void _ActivateAncient()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, ancientValue);
        }

        protected override void _InActivateCommon()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, commonValue * -1);
        }

        protected override void _InActivateRare()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, rareValue * -1);
        }

        protected override void _InActivateUnique()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, uniqueValue * -1);
        }

        protected override void _InActivateEpic()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, epicValue * -1);
        }

        protected override void _InActivateSpecial()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, specialValue * -1);
        }

        protected override void _InActivateLegendary()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, legendaryValue * -1);
        }

        protected override void _InActivateAncient() 
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.CriticalProbability, ancientValue * -1);
        }
    }
}