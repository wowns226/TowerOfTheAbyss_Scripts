...
namespace ProjectL
{
    public class CriticalDamagebuffRelic : Relic
    {
        ...
        {
            AddRelicSet(Player.RelicSetBag.Get(nameof(CriticalRelicSet)));
        }

        protected override void _ActivateCommon()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, commonValue);
        }

        protected override void _ActivateRare()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, epicValue);
        }

        protected override void _ActivateSpecial()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, specialValue);
        }

        protected override void _ActivateLegendary()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, legendaryValue);
        }

        protected override void _ActivateAncient()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, ancientValue);
        }

        protected override void _InActivateCommon()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, commonValue * -1);
        }

        protected override void _InActivateRare()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, rareValue * -1);
        }

        protected override void _InActivateUnique()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, uniqueValue * -1);
        }

        protected override void _InActivateEpic()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, epicValue * -1);
        }

        protected override void _InActivateSpecial()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, specialValue * -1);
        }

        protected override void _InActivateLegendary()
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, legendaryValue * -1);
        }

        protected override void _InActivateAncient() 
        {
            Player.AllUpgradeStatPercentage(UnitType.Mob, StatType.CriticalDamagePercentage, ancientValue * -1);
        }
    }
}