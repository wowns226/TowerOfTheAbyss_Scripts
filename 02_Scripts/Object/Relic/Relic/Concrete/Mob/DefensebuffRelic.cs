...
namespace ProjectL
{
    public class DefensebuffRelic : Relic
    {
        ...
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, commonValue);
        }

        protected override void _ActivateRare()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, rareValue);
        }

        protected override void _ActivateUnique()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, uniqueValue);
        }

        protected override void _ActivateEpic()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, epicValue);
        }

        protected override void _ActivateSpecial()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, specialValue);
        }

        protected override void _ActivateLegendary()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, legendaryValue);
        }

        protected override void _ActivateAncient()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, ancientValue);
        }

        protected override void _InActivateCommon()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, commonValue * -1);
        }

        protected override void _InActivateRare()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, rareValue * -1);
        }

        protected override void _InActivateUnique()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, uniqueValue * -1);
        }

        protected override void _InActivateEpic()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, epicValue * -1);
        }

        protected override void _InActivateSpecial()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, specialValue * -1);
        }

        protected override void _InActivateLegendary()
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, legendaryValue * -1);
        }

        protected override void _InActivateAncient() 
        {
            Player.AllUpgradeStat(UnitType.Mob, StatType.Defense, ancientValue * -1);
        }
    }
}
