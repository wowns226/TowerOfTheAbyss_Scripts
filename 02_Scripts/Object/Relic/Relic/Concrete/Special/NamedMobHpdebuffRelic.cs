...
namespace ProjectL
{
    public class NamedMobHpdebuffRelic : Relic
    {
        ...
        private void DecNamedMobHp(Unit unit)
        {
            if (unit.MobType == MobType.Named)
            {
                unit.UpgradeStat(StatType.Hp, decreaseHpValue * -1);
            }
        }
    }
}