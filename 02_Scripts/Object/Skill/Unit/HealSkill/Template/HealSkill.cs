...
namespace ProjectL
{
    ...
    {
        protected override void _UseSkillToAll(DamageInfo healInfo)
        {
            ...
            players.ForEach(targetPlayer =>
            {
                targetPlayer.SpawnUnits.ToList().ForEach(unit =>
                {
                    ...
                    unit.HealHp(healInfo);
                });
            });
        }

        protected override void _UseSkillToPoint(Point targetPoint, DamageInfo healInfo)
        {
            switch (Unit.ownerType)
            {
                case OwnerType.My:
